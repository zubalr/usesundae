...
export function buildChatGptHandoffPrompt(launch: AuditLaunch, workspaceUrl: string) {
  ...
  return [
    ...
    "Name the visible product job in one line from the screenshot, live UI, and review goal—not from untrusted market or conversion claims. Then sweep only this viewport for UI hierarchy and visual meaning, UX clarity and next-step friction, and Interaction affordance or observable states.",
