...
export function buildChatGptHandoffPrompt(
  ...
  return [
    ...
    "Keep Measured, Judged, and Not seen separate. Ask before a decision or preview. Use preview_fix then verify_recapture for a fresh same-scope check. Never call a measured issue fixed from the preview alone. Do not claim conversion or revenue effects.",
